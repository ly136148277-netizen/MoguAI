...
> **状态说明（2026-07-23）：** 本文件记录“到 v2.0”的实施路线，现已成为历史基线。
> 当前上位目标见 [`MOGU_NORTH_STAR_AND_CAPABILITY_FUSION.md`](./MOGU_NORTH_STAR_AND_CAPABILITY_FUSION.md)；当前里程碑见 [`PUBLIC_RELEASE_FINAL_FREEZE.md`](./PUBLIC_RELEASE_FINAL_FREEZE.md)。
> Public RC 完成后进入 2.1–3.0 能力融合路线；不以 v2.0 公共化作为项目终点。
