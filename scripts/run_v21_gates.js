...
const OUTPUT = path.join(ROOT, "benchmarks", "v2.1", "results", "regression-gates.json");
const gates = [
  ...
  { id: "dependency-audit", args: ["run", "audit:v2.1-deps"], count: /"ok": true/ },
];
...
const report = {
  schemaVersion: 1,
  kind: "mogu-v2.1-regression-gates",
